...
public class SimpleRunCPE extends Thread {
  ...
  public SimpleRunCPE(String args[]) throws Exception {
    ...
    System.out.println("To abort processing, type ${symbol_escape}"abort${symbol_escape}" and press enter.");
    while (true) {
  ...
  private static void printUsageMessage() {
    System.out.println(" Arguments to the program are as follows : ${symbol_escape}n"
  ...
  class StatusCallbackListenerImpl implements StatusCallbackListener {
     ...
     * 
     * @see org.apache.uima.collection.processing.StatusCallbackListener${symbol_pound}initializationComplete()
     */
     ...
     * 
     * @see org.apache.uima.collection.processing.StatusCallbackListener${symbol_pound}batchProcessComplete()
     * 
     */
     ...
     * 
     * @see org.apache.uima.collection.processing.StatusCallbackListener${symbol_pound}collectionProcessComplete()
     */
    public void collectionProcessComplete() {
      ...
      System.out.println("${symbol_escape}n${symbol_escape}n ------------------ PERFORMANCE REPORT ------------------${symbol_escape}n");
     ...
     * 
     * @see org.apache.uima.collection.processing.StatusCallbackListener${symbol_pound}paused()
     */
    public void paused() {
     ...
     * 
     * @see org.apache.uima.collection.processing.StatusCallbackListener${symbol_pound}resumed()
     */
    public void resumed() {
     ...
     * 
     * @see org.apache.uima.collection.processing.StatusCallbackListener${symbol_pound}aborted()
     */
    public void aborted() {
